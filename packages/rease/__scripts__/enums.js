...
const DIR_SRC_CORE = pathResolve(__dirname, '../src/__src__/core')
const FILE_ENUMS_DEV = pathResolve(DIR_SRC_CORE, '__enums__.ts')
const FILE_ENUMS = pathResolve(DIR_SRC_CORE, '__enums__AUTOGEN.ts')
...
if (!isDev) {
  ...
  fsWatchFile(FILE_ENUMS_DEV, { interval: 250 }, initChange)
}
